...
setup(
  ...
  url = 'https://github.com/joelbarmettlerUZH/googleandroid',
  download_url = 'https://github.com/joelbarmettlerUZH/googleandroid/archive/pypi-0_1_3.tar.gz',
